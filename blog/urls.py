...
from .views import (
    ...
    FavouritesView,
    LikePostView,
    WikidataEntityAutocompleteView,
    generate_preview,
...
urlpatterns = [
    ...
    path(
        "post/<int:space_id>/new/",
        PostCreateUnderSpaceView.as_view(),
        name="post-create-under-space",
    ),
    ...
    path(
        "wikidataentity-autocomplete/",
        WikidataEntityAutocompleteView.as_view(),
        name="wikidataentity-autocomplete",
    ),
    # path(
    #     "wikidatasubtype-autocomplete/",
    #     WikidataSubtypeAutocompleteView.as_view(),
    #     name="wikidatasubtype-autocomplete",
    # ),
]
